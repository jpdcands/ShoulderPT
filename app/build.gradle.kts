...
android {
    namespace = "com.example.shoulderpt"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.shoulderpt"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    dependencies {
        ...
        implementation("androidx.compose.foundation:foundation-layout-android:1.7.0-alpha04")
