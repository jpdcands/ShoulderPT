...
@Composable
fun ArmReachSide(navController: NavController) {
    ...
    Column(
        ...
        Text("Arm Reach Side", style = MaterialTheme.typography.headlineLarge)
...
@Composable
fun DefaultPreviewArmReachSide() {

    val navController = rememberNavController()

    ArmReachSide(navController)
}
