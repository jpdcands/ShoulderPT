...
fun InternalRotator(navController: NavController, viewModel: ExerciseViewModel = viewModel()) {
    ...
    Column(
        ...
        Text("Internal Rotation", style = MaterialTheme.typography.headlineLarge)
        Spacer(modifier = Modifier.height(2.dp))
        Image(
            painter = painterResource(id = R.drawable.internalrotator), // Replace with your image resource
            contentDescription = "Internal Rotation",
